				...
				{questions === 'user' ? (
					<div className={classes.container}>
						<FaqElement question="How do I find the best trainer for me?">
							<p>
								You should choose a sport that interests you, then the price you are willing to pay. This will allow you
								to filter out the trainers that don't interest you.
							</p>
						</FaqElement>
						...
						<FaqElement question="Does your service charge any fees?">
							<p>
								We are a 100% free service, we make our living mainly by advertising and promoting trainers so we don't
								charge any fees to either trainers or users.
							</p>
						</FaqElement>
					...
					<div className={classes.container}>
						<FaqElement question="Is it free to be a trainer on your website?">
							<p>
								Our service is 100% free of any cost for trainers inserting announcements. However, it is also possible
								to buy an ad that will help you appear on the homepage and get more customers
							</p>
						</FaqElement>
